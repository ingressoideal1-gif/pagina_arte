document.addEventListener('DOMContentLoaded', () => {
    ...
    window.addNewObservationBlock = function() {
        ...
        newWindow.innerHTML = `
            <div class="block-header" style="display: flex; justify-content: space-between; align-items: center; margin-bottom: 0.5rem; background: var(--bg-color); padding: 0.5rem; border-radius: var(--radius-sm); border: 1px solid var(--border-color); gap: 1rem;">
